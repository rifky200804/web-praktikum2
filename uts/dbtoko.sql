...
(1, '2023-05-08', 'Rifky', 'Depok', '082094374577', 'ziyad@gmail.com', 2, 'Pesanan Meja Belajar', 2),
(3, '2023-05-14', 'mul', 'jl ujung garung', '08429183198', 'mul@gmail.com', 1, 'satu aja', 2);
...
INSERT INTO `produk` (`id`, `kode`, `nama`, `harga`, `stok`, `deskripsi`, `kategori_produk_id`) VALUES
(2, 'MB01', 'Meja Belajar', 2000000, 6, 'Meja yang difungsikan untuk membaca, menulis, dan yang pasti untuk belajar.', 2),
(4, 'H1R4', 'Xiaomi Redmi 1A', 1000000, 10, 'Hp Xiaomi Lama', 1),
(5, 'U12W1', 'Karpet', 100000, 5, '-', 2),
(8, 'UKJSA12', 'Kabel data dan charger', 50000, 150, 'kabel data dan charger', 1),
(9, 'CK123109', 'Celengan', 5000, 100, 'celengan nabung yuk', 2);
